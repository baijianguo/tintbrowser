...
public class UrlUtils {
	...
	public static String getRawSearchUrl(Context context) {
		String currentSearchUrl = PreferenceManager.getDefaultSharedPreferences(context).getString(Constants.PREFERENCE_SEARCH_URL, context.getString(R.string.SearchUrlBaidu));
