...
package com.iumol.tint.ui.managers;
...
import com.iumol.tint.R;
import com.iumol.tint.controllers.Controller;
import com.iumol.tint.model.DownloadItem;
import com.iumol.tint.providers.BookmarksWrapper;
import com.iumol.tint.tasks.ThumbnailSaver;
import com.iumol.tint.ui.activities.BookmarksActivity;
import com.iumol.tint.ui.activities.EditBookmarkActivity;
import com.iumol.tint.ui.activities.TintBrowserActivity;
import com.iumol.tint.ui.components.CustomWebView;
import com.iumol.tint.ui.dialogs.GeolocationPermissionsDialog;
import com.iumol.tint.ui.fragments.BaseWebViewFragment;
import com.iumol.tint.ui.fragments.StartPageFragment;
import com.iumol.tint.utils.ApplicationUtils;
import com.iumol.tint.utils.Constants;
...
public abstract class BaseUIManager implements UIManager {//, WebViewFragmentListener {
	...
	public void addTab(boolean loadHomePage, boolean privateBrowsing) {
		if (loadHomePage) {
			addTab(
					PreferenceManager.getDefaultSharedPreferences(mActivity).getString(Constants.PREFERENCE_HOME_PAGE, Constants.URL_HOME_PAGE),
					false,
					privateBrowsing);
		} else {
	...
	public void loadHomePage() {
		...
		loadUrl(PreferenceManager.getDefaultSharedPreferences(mActivity).getString(Constants.PREFERENCE_HOME_PAGE, Constants.URL_HOME_PAGE));
	}
	...
	public void saveTabs() {
		String userStartPage = PreferenceManager.getDefaultSharedPreferences(mActivity).getString(Constants.PREFERENCE_HOME_PAGE, Constants.URL_HOME_PAGE);
	...
	protected boolean isHomePageStartPage() {
		return Constants.URL_ABOUT_START.equals(PreferenceManager.getDefaultSharedPreferences(mActivity).getString(Constants.PREFERENCE_HOME_PAGE, Constants.URL_HOME_PAGE));
	}
	...
	private boolean isCurrentTabReusable() {
		String homePageUrl = PreferenceManager.getDefaultSharedPreferences(mActivity).getString(Constants.PREFERENCE_HOME_PAGE, Constants.URL_HOME_PAGE);
		BaseWebViewFragment currentWebViewFragment = getCurrentWebViewFragment();
