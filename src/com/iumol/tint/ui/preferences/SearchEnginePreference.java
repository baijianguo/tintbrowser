...
package com.iumol.tint.ui.preferences;

import java.util.List;
import java.util.concurrent.atomic.AtomicReference;

import com.iumol.tint.R;
import com.iumol.tint.model.SearchUrlAdapter;
import com.iumol.tint.model.SearchUrlGroup;
import com.iumol.tint.model.SearchUrlItem;
import com.iumol.tint.tasks.SearchUrlTask;
import com.iumol.tint.tasks.SearchUrlTask.ISearchUrlTaskListener;
...
public class SearchEnginePreference extends DialogPreference implements ISearchUrlTaskListener {
	...
	private String getCurrentSearchEngineName() {
		...
		if (TextUtils.isEmpty(name)) {
			...
			if (getContext().getString(R.string.SearchUrlBaidu).equals(searchUrl)) {
